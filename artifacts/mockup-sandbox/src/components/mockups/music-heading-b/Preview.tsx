...
/* HK + MUSIC stacked wordmark */
.wordmark{display:flex;flex-direction:column;align-items:center;gap:0px;}
.hk-text{font-size:52px;font-weight:900;letter-spacing:6px;line-height:1;background:linear-gradient(180deg,#ff3a1a 0%,#8B0000 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.music-text{font-size:11px;font-weight:600;letter-spacing:7px;color:rgba(255,255,255,0.35);text-transform:uppercase;margin-top:1px;}
