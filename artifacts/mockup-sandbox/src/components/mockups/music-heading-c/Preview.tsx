...
/* Header */
.header{position:relative;z-index:10;display:flex;flex-direction:column;align-items:center;padding-top:52px;gap:10px;padding-bottom:4px;}
...
/* HK logo inline + MUSIC horizontal */
.brand-row{display:flex;align-items:baseline;gap:10px;}
.hk-badge{font-size:38px;font-weight:900;letter-spacing:3px;line-height:1;background:linear-gradient(180deg,#ff3a1a 0%,#8B0000 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.divider-dot{width:4px;height:4px;border-radius:50%;background:#E8230A;margin-bottom:5px;flex-shrink:0;}
.music-badge{font-size:22px;font-weight:700;letter-spacing:4px;color:rgba(255,255,255,0.55);text-transform:uppercase;}

.cards{position:relative;z-index:10;padding:32px 16px 0;display:flex;flex-direction:column;gap:10px;}
...
<div class="screen">
  ...
  <div class="header">
    <div class="brand-row">
      <span class="hk-badge">HK</span>
      <div class="divider-dot"></div>
      <span class="music-badge">MUSIC</span>
    </div>
    <div class="eq-bars">
