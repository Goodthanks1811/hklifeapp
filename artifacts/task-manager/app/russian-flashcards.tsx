...
const SIZES = [5, 10, 15, 20, 33] as const;
    ...
    return (
      <View style={[s.root, { paddingTop: topPad }]}>
        ...
        <ScrollView contentContainerStyle={s.centerContainer}>
          ...
          <Text style={s.subtitle}>{good ? "Great work! Хорошо!" : "Keep practising!"}</Text>
  ...
  return (
    <View style={[s.root, { paddingTop: topPad }]}>
      ...
      <Animated.View style={[{ flex: 1 }, { transform: [{ translateY: Animated.multiply(kbOffset, -1) }] }]}>
        <ScrollView
          contentContainerStyle={s.quizContainer}
...
const s = StyleSheet.create({
  ...
  cardChar:       { fontSize: 120, lineHeight: 130, fontFamily: "Inter_700Bold", color: "#fff", marginBottom: 10 },
  ...
  mChar:          { fontSize: 22, fontFamily: "Inter_700Bold", color: "#fff", minWidth: 28 },
