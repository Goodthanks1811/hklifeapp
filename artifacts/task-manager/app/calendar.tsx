...
const cg = StyleSheet.create({
  ...
  dow:      { width: DAY_W, textAlign: "center", color: TEXT, fontSize: 11, fontFamily: "Inter_600SemiBold", letterSpacing: 0.3 },
...
const am = StyleSheet.create({
  ...
  infoTime:         { color: TEXT, fontSize: 13, fontFamily: "Inter_700Bold", paddingBottom: 2 },
  ...
  cancelTxt:        { color: "#ffffff", fontSize: 15, fontFamily: "Inter_500Medium" },
});
...
const s = StyleSheet.create({
  ...
  tStart:     { width: 58, fontSize: 13, fontFamily: "Inter_700Bold", color: TEXT },
  ...
  errorTxt:   { color: TEXT, fontSize: 14, textAlign: "center", fontFamily: "Inter_400Regular", lineHeight: 20 },
  ...
  emptyTxt:   { color: TEXT, fontSize: 14, fontFamily: "Inter_400Regular" },
