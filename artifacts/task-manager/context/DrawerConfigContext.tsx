...
export const ALL_ITEMS: Record<SectionKey, MenuItem[]> = {
  ...
  reports: [
    { label: "Mood",          icon: "activity",  route: "/mood-report",  description: "Monthly mood charts" },
  ...
  apps: [
    ...
    { label: "Music Player",      icon: "music",  route: "/music",             description: "My Music, Spotify & Apple Music" },
  ...
  uikit: [
    ...
    { label: "Swipe Delete",   icon: "trash-2", route: "/ui-kit/swipe-delete",   description: "Compare button designs" },
